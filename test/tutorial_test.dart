...
import 'package:dreamy_tales/pages/tutorial_screen_state.dart';
...
void main() {
  ...
  testWidgets('Tutorial Screen State Test', (WidgetTester tester) async {
    ...
    expect(find.byKey(Key('pageIndicator_1')), findsOneWidget); // Adjust this based on your actual slide content
    ...
    expect(find.byKey(Key('pageIndicator_0')), findsOneWidget); // Adjust this based on your actual slide content
  });
  ...
  testWidgets('IconButton should navigate to next and previous slide', (WidgetTester tester) async {
    ...
    expect(find.byKey(Key('pageIndicator_1')), findsOneWidget);
    ...
    expect(find.byKey(Key('pageIndicator_2')), findsOneWidget);
